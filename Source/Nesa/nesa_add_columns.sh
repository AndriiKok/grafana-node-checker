...
curl -sSL https://raw.githubusercontent.com/AndriiKok/grafana-node-checker/refs/heads/main/Source/Nesa/nesa_status_add_column.js > "/root/adding_panel_column/nesa_status_add_column.js"
sed -i "s/server_ip/${GRAFANA_SERVER_IP}/g" /root/adding_panel_column/nesa_status_add_column.js
sed -i "s/api_key/${GRAFANA_API_KEY}/g" /root/adding_panel_column/nesa_status_add_column.js
