...
curl -sSL https://raw.githubusercontent.com/AndriiKok/grafana-node-checker/refs/heads/main/Source/Dill/dill_balance_check.js > "/root/Grafana_node_checker/dill_balance_check.js"
...
sed -i "s/PUB_KEY/$pubkey/" /root/Grafana_node_checker/dill_balance_check.js

# Добавляем файл в крон с частотой выполнения каждую минуту
source .profile
#cron_entry="* * * * * $node_path /root/Grafana_node_checker/dill_balance_check.js"
