...
curl -sSL https://raw.githubusercontent.com/AndriiKok/grafana-node-checker/refs/heads/main/Source/Drosera/drosera_health_check.js > "/root/Grafana_node_checker/drosera_health_check.js"
...
source .profile
cron_entry="* * * * * $node_path /root/Grafana_node_checker/drosera_health_check.js"
